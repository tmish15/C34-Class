...
function setup() 
{
  ...
  blowButton = createImg("baloon2.png")
  blowButton.position(260, 370)
  blowButton.size(120, 120)
...
function draw() 
{
  ...
  drawSprites();
  if(collide(fruit, star, 20)== true && xyz === false){
    xyz = true
    star.visible = false
    flag ++
    if(flag == 1){
  ...
  if(collide(fruit, star2, 20)== true && abc === false){
    //star2.visible = false
    abc = true 
    star2.destroy()
